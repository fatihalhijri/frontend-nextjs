...
export const AsideFa: React.FC<AsideFaProps> = ({
  isOpen,
  title,
  children,
  onSubmit,
  ...
  return (
    <animated.div
      ...
      className={
        "shadow-sm inset-0 sticky  z-50 md:w-[50%] lg:w-[30%] xl:w-[20%] w-full flex flex-col bg-white border border-gray-100 px-5 "
      }
    >
